...
from app.schemas.consumer import ConsumerCreate, ConsumerListResponse, ConsumerRead, to_consumer_read
...
def list_consumer_profiles(
    service: ConsumerApplicationService = Depends(get_consumer_service),
