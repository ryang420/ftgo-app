...
Enable kitchen staff to accept or reject kitchen tickets, driving the kitchen ticket and order state machines. Accepted tickets move the order to PREPARING; rejected tickets cancel the order. All decisions are published as domain events through the transactional outbox.
