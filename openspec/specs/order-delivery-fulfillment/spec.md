...
Delivery-service creates and advances delivery records from ready kitchen tickets, publishes delivery lifecycle events through the transactional outbox, and order-service reflects delivery progress through final `DELIVERED` status.
